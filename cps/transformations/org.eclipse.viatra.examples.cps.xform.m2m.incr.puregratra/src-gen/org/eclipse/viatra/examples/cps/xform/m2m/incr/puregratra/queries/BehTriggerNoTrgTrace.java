 ...
 * <p>Original source:
 *         <code><pre>
 *         pattern behTriggerNoTrgTrace(behTrigger : BehaviorTransition, behTarget : BehaviorTransition) {
...
public final class BehTriggerNoTrgTrace extends BaseGeneratedEMFQuerySpecification<BehTriggerNoTrgTrace.Matcher> {
  /**
   * Pattern-specific match representation of the org.eclipse.viatra.examples.cps.xform.m2m.incr.puregratra.queries.behTriggerNoTrgTrace pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "org.eclipse.viatra.examples.cps.xform.m2m.incr.puregratra.queries.behTriggerNoTrgTrace";
    }
    
    @Override
    public List<String> parameterNames() {
      return BehTriggerNoTrgTrace.Match.parameterNames;
    }
    ...
    @Override
    public BehTriggerNoTrgTrace.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof BehTriggerNoTrgTrace.Match)) {
          BehTriggerNoTrgTrace.Match other = (BehTriggerNoTrgTrace.Match) obj;
    ...
    @Override
    public BehTriggerNoTrgTrace specification() {
     ...
     * 
     */
    public static BehTriggerNoTrgTrace.Match newEmptyMatch() {
     ...
     * 
     */
    public static BehTriggerNoTrgTrace.Match newMutableMatch(final BehaviorTransition pBehTrigger, final BehaviorTransition pBehTarget) {
     ...
     * 
     */
    public static BehTriggerNoTrgTrace.Match newMatch(final BehaviorTransition pBehTrigger, final BehaviorTransition pBehTarget) {
      return new Immutable(pBehTrigger, pBehTarget);
    }
    
    private static final class Mutable extends BehTriggerNoTrgTrace.Match {
    ...
    private static final class Immutable extends BehTriggerNoTrgTrace.Match {
  ...
  /**
   * Generated pattern matcher API of the org.eclipse.viatra.examples.cps.xform.m2m.incr.puregratra.queries.behTriggerNoTrgTrace pattern,
   ...
   * 
   * @see Match
   * @see BehTriggerNoTrgTrace
   * 
   */
  public static class Matcher extends BaseMatcher<BehTriggerNoTrgTrace.Match> {
    /**
     ...
     * 
     */
    public static BehTriggerNoTrgTrace.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static BehTriggerNoTrgTrace.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(BehTriggerNoTrgTrace.Matcher.class);
     ...
     * 
     */
    public Collection<BehTriggerNoTrgTrace.Match> getAllMatches(final BehaviorTransition pBehTrigger, final BehaviorTransition pBehTarget) {
     ...
     * 
     */
    public Stream<BehTriggerNoTrgTrace.Match> streamAllMatches(final BehaviorTransition pBehTrigger, final BehaviorTransition pBehTarget) {
     ...
     * 
     */
    public Optional<BehTriggerNoTrgTrace.Match> getOneArbitraryMatch(final BehaviorTransition pBehTrigger, final BehaviorTransition pBehTarget) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final BehaviorTransition pBehTrigger, final BehaviorTransition pBehTarget, final Consumer<? super BehTriggerNoTrgTrace.Match> processor) {
     ...
     * 
     */
    public BehTriggerNoTrgTrace.Match newMatch(final BehaviorTransition pBehTrigger, final BehaviorTransition pBehTarget) {
      return BehTriggerNoTrgTrace.Match.newMatch(pBehTrigger, pBehTarget);
    }
     ...
     * 
     */
    public Stream<BehaviorTransition> streamAllValuesOfbehTrigger(final BehTriggerNoTrgTrace.Match partialMatch) {
     ...
     * 
     */
    public Set<BehaviorTransition> getAllValuesOfbehTrigger(final BehTriggerNoTrgTrace.Match partialMatch) {
     ...
     * 
     */
    public Stream<BehaviorTransition> streamAllValuesOfbehTarget(final BehTriggerNoTrgTrace.Match partialMatch) {
     ...
     * 
     */
    public Set<BehaviorTransition> getAllValuesOfbehTarget(final BehTriggerNoTrgTrace.Match partialMatch) {
    ...
    @Override
    protected BehTriggerNoTrgTrace.Match tupleToMatch(final Tuple t) {
      try {
          return BehTriggerNoTrgTrace.Match.newMatch((BehaviorTransition) t.get(POSITION_BEHTRIGGER), (BehaviorTransition) t.get(POSITION_BEHTARGET));
    ...
    @Override
    protected BehTriggerNoTrgTrace.Match arrayToMatch(final Object[] match) {
      try {
          return BehTriggerNoTrgTrace.Match.newMatch((BehaviorTransition) match[POSITION_BEHTRIGGER], (BehaviorTransition) match[POSITION_BEHTARGET]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected BehTriggerNoTrgTrace.Match arrayToMatchMutable(final Object[] match) {
      try {
          return BehTriggerNoTrgTrace.Match.newMutableMatch((BehaviorTransition) match[POSITION_BEHTRIGGER], (BehaviorTransition) match[POSITION_BEHTARGET]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<BehTriggerNoTrgTrace.Matcher> querySpecification() {
      return BehTriggerNoTrgTrace.instance();
    }
  }
  
  private BehTriggerNoTrgTrace() {
   ...
   * 
   */
  public static BehTriggerNoTrgTrace instance() {
    try{
  ...
  @Override
  protected BehTriggerNoTrgTrace.Matcher instantiate(final ViatraQueryEngine engine) {
    return BehTriggerNoTrgTrace.Matcher.on(engine);
  }
  
  @Override
  public BehTriggerNoTrgTrace.Matcher instantiate() {
    return BehTriggerNoTrgTrace.Matcher.create();
  }
  
  @Override
  public BehTriggerNoTrgTrace.Match newEmptyMatch() {
    return BehTriggerNoTrgTrace.Match.newEmptyMatch();
  }
  
  @Override
  public BehTriggerNoTrgTrace.Match newMatch(final Object... parameters) {
    return BehTriggerNoTrgTrace.Match.newMatch((org.eclipse.viatra.examples.cps.deployment.BehaviorTransition) parameters[0], (org.eclipse.viatra.examples.cps.deployment.BehaviorTransition) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: org.eclipse.viatra.examples.cps.xform.m2m.incr.puregratra.queries.BehTriggerNoTrgTrace (visibility: PUBLIC, simpleName: BehTriggerNoTrgTrace, identifier: org.eclipse.viatra.examples.cps.xform.m2m.incr.puregratra.queries.BehTriggerNoTrgTrace, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: org.eclipse.viatra.examples.cps.xform.m2m.incr.puregratra.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: org.eclipse.viatra.examples.cps.xform.m2m.incr.puregratra.queries.BehTriggerNoTrgTrace (visibility: PUBLIC, simpleName: BehTriggerNoTrgTrace, identifier: org.eclipse.viatra.examples.cps.xform.m2m.incr.puregratra.queries.BehTriggerNoTrgTrace, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: org.eclipse.viatra.examples.cps.xform.m2m.incr.puregratra.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final BehTriggerNoTrgTrace INSTANCE = new BehTriggerNoTrgTrace();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final BehTriggerNoTrgTrace.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          //     neg find cps2depTrace(_, _, _, behTarget)
          new NegativePatternCall(body, Tuples.flatTupleOf(var___0_, var___1_, var___2_, var_behTarget), Cps2depTrace.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
