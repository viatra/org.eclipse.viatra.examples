 ...
 * <p>Original source:
 *         <code><pre>
 *         pattern connectionLost(behTrigger : BehaviorTransition, behTarget : BehaviorTransition) {
 *             find cps2depTrace(cps2dep, _, cpsTrigger, behTrigger);
 *             find cps2depTrace(cps2dep, _, cpsTarget, behTarget);
 *             neg find triggerPairWithoutReachability(_,_, _, _, cpsTrigger, cpsTarget);
 *         } or {
 *             find cps2depTrace(_, _, cpsTrigger, behTrigger);
 *             find cps2depTrace(_, _, cpsTarget, behTarget);
 *             find triggerPairWithoutReachability(srcHost,trgHost, _, _, cpsTrigger, cpsTarget);
 *             neg find reachableHosts(srcHost,trgHost);
 *         }
 * </pre></code>
 * 
 * @see Matcher
...
public final class ConnectionLost extends BaseGeneratedEMFQuerySpecification<ConnectionLost.Matcher> {
  /**
   * Pattern-specific match representation of the org.eclipse.viatra.examples.cps.xform.m2m.incr.puregratra.queries.connectionLost pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "org.eclipse.viatra.examples.cps.xform.m2m.incr.puregratra.queries.connectionLost";
    }
    
    @Override
    public List<String> parameterNames() {
      return ConnectionLost.Match.parameterNames;
    }
    ...
    @Override
    public ConnectionLost.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ConnectionLost.Match)) {
          ConnectionLost.Match other = (ConnectionLost.Match) obj;
    ...
    @Override
    public ConnectionLost specification() {
     ...
     * 
     */
    public static ConnectionLost.Match newEmptyMatch() {
     ...
     * 
     */
    public static ConnectionLost.Match newMutableMatch(final BehaviorTransition pBehTrigger, final BehaviorTransition pBehTarget) {
     ...
     * 
     */
    public static ConnectionLost.Match newMatch(final BehaviorTransition pBehTrigger, final BehaviorTransition pBehTarget) {
      return new Immutable(pBehTrigger, pBehTarget);
    }
    
    private static final class Mutable extends ConnectionLost.Match {
    ...
    private static final class Immutable extends ConnectionLost.Match {
  ...
  /**
   * Generated pattern matcher API of the org.eclipse.viatra.examples.cps.xform.m2m.incr.puregratra.queries.connectionLost pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<ConnectionLost.Match> {
    /**
     ...
     * 
     */
    public static ConnectionLost.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ConnectionLost.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ConnectionLost.Matcher.class);
     ...
     * 
     */
    public Collection<ConnectionLost.Match> getAllMatches(final BehaviorTransition pBehTrigger, final BehaviorTransition pBehTarget) {
     ...
     * 
     */
    public Stream<ConnectionLost.Match> streamAllMatches(final BehaviorTransition pBehTrigger, final BehaviorTransition pBehTarget) {
     ...
     * 
     */
    public Optional<ConnectionLost.Match> getOneArbitraryMatch(final BehaviorTransition pBehTrigger, final BehaviorTransition pBehTarget) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final BehaviorTransition pBehTrigger, final BehaviorTransition pBehTarget, final Consumer<? super ConnectionLost.Match> processor) {
     ...
     * 
     */
    public ConnectionLost.Match newMatch(final BehaviorTransition pBehTrigger, final BehaviorTransition pBehTarget) {
      return ConnectionLost.Match.newMatch(pBehTrigger, pBehTarget);
    }
     ...
     * 
     */
    public Stream<BehaviorTransition> streamAllValuesOfbehTrigger(final ConnectionLost.Match partialMatch) {
     ...
     * 
     */
    public Set<BehaviorTransition> getAllValuesOfbehTrigger(final ConnectionLost.Match partialMatch) {
     ...
     * 
     */
    public Stream<BehaviorTransition> streamAllValuesOfbehTarget(final ConnectionLost.Match partialMatch) {
     ...
     * 
     */
    public Set<BehaviorTransition> getAllValuesOfbehTarget(final ConnectionLost.Match partialMatch) {
    ...
    @Override
    protected ConnectionLost.Match tupleToMatch(final Tuple t) {
      try {
          return ConnectionLost.Match.newMatch((BehaviorTransition) t.get(POSITION_BEHTRIGGER), (BehaviorTransition) t.get(POSITION_BEHTARGET));
    ...
    @Override
    protected ConnectionLost.Match arrayToMatch(final Object[] match) {
      try {
          return ConnectionLost.Match.newMatch((BehaviorTransition) match[POSITION_BEHTRIGGER], (BehaviorTransition) match[POSITION_BEHTARGET]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ConnectionLost.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ConnectionLost.Match.newMutableMatch((BehaviorTransition) match[POSITION_BEHTRIGGER], (BehaviorTransition) match[POSITION_BEHTARGET]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ConnectionLost.Matcher> querySpecification() {
      return ConnectionLost.instance();
    }
  }
   ...
   * 
   */
  public static ConnectionLost instance() {
    try{
  ...
  @Override
  protected ConnectionLost.Matcher instantiate(final ViatraQueryEngine engine) {
    return ConnectionLost.Matcher.on(engine);
  }
  
  @Override
  public ConnectionLost.Matcher instantiate() {
    return ConnectionLost.Matcher.create();
  }
  
  @Override
  public ConnectionLost.Match newEmptyMatch() {
    return ConnectionLost.Match.newEmptyMatch();
  }
  
  @Override
  public ConnectionLost.Match newMatch(final Object... parameters) {
    return ConnectionLost.Match.newMatch((org.eclipse.viatra.examples.cps.deployment.BehaviorTransition) parameters[0], (org.eclipse.viatra.examples.cps.deployment.BehaviorTransition) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: org.eclipse.viatra.examples.cps.xform.m2m.incr.puregratra.queries.ConnectionLost (visibility: PUBLIC, simpleName: ConnectionLost, identifier: org.eclipse.viatra.examples.cps.xform.m2m.incr.puregratra.queries.ConnectionLost, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: org.eclipse.viatra.examples.cps.xform.m2m.incr.puregratra.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: org.eclipse.viatra.examples.cps.xform.m2m.incr.puregratra.queries.ConnectionLost (visibility: PUBLIC, simpleName: ConnectionLost, identifier: org.eclipse.viatra.examples.cps.xform.m2m.incr.puregratra.queries.ConnectionLost, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: org.eclipse.viatra.examples.cps.xform.m2m.incr.puregratra.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ConnectionLost INSTANCE = new ConnectionLost();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ConnectionLost.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          //     find cps2depTrace(cps2dep, _, cpsTrigger, behTrigger)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_cps2dep, var___0_, var_cpsTrigger, var_behTrigger), Cps2depTrace.instance().getInternalQueryRepresentation());
          //     find cps2depTrace(cps2dep, _, cpsTarget, behTarget)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_cps2dep, var___1_, var_cpsTarget, var_behTarget), Cps2depTrace.instance().getInternalQueryRepresentation());
          //     neg find triggerPairWithoutReachability(_,_, _, _, cpsTrigger, cpsTarget)
          new NegativePatternCall(body, Tuples.flatTupleOf(var___2_, var___3_, var___4_, var___5_, var_cpsTrigger, var_cpsTarget), TriggerPairWithoutReachability.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      {
          PBody body = new PBody(this);
          ...
          PVariable var___3_ = body.getOrCreateVariableByName("_<3>");
          PVariable var_cpsTarget = body.getOrCreateVariableByName("cpsTarget");
          PVariable var_srcHost = body.getOrCreateVariableByName("srcHost");
          PVariable var_trgHost = body.getOrCreateVariableByName("trgHost");
          PVariable var___4_ = body.getOrCreateVariableByName("_<4>");
          PVariable var___5_ = body.getOrCreateVariableByName("_<5>");
          new TypeConstraint(body, Tuples.flatTupleOf(var_behTrigger), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://org.eclipse.viatra/model/deployment", "BehaviorTransition")));
          new TypeConstraint(body, Tuples.flatTupleOf(var_behTarget), new EClassTransitiveInstancesKey((EClass)getClassifierLiteral("http://org.eclipse.viatra/model/deployment", "BehaviorTransition")));
          ...
          //     find cps2depTrace(_, _, cpsTrigger, behTrigger)
          new PositivePatternCall(body, Tuples.flatTupleOf(var___0_, var___1_, var_cpsTrigger, var_behTrigger), Cps2depTrace.instance().getInternalQueryRepresentation());
          //     find cps2depTrace(_, _, cpsTarget, behTarget)
          new PositivePatternCall(body, Tuples.flatTupleOf(var___2_, var___3_, var_cpsTarget, var_behTarget), Cps2depTrace.instance().getInternalQueryRepresentation());
          //     find triggerPairWithoutReachability(srcHost,trgHost, _, _, cpsTrigger, cpsTarget)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_srcHost, var_trgHost, var___4_, var___5_, var_cpsTrigger, var_cpsTarget), TriggerPairWithoutReachability.instance().getInternalQueryRepresentation());
          //     neg find reachableHosts(srcHost,trgHost)
          new NegativePatternCall(body, Tuples.flatTupleOf(var_srcHost, var_trgHost), ReachableHosts.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
