 ...
 * <p>Original source:
 *         <code><pre>
 *         pattern behTriggerConnLost(behTrigger : BehaviorTransition, behTarget : BehaviorTransition) {
 *             find alreadyTriggered(behTrigger,behTarget);
 *             find connectionLost(behTrigger,behTarget);
 *         }
 * </pre></code>
 * 
 * @see Matcher
...
public final class BehTriggerConnLost extends BaseGeneratedEMFQuerySpecification<BehTriggerConnLost.Matcher> {
  /**
   * Pattern-specific match representation of the org.eclipse.viatra.examples.cps.xform.m2m.incr.puregratra.queries.behTriggerConnLost pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "org.eclipse.viatra.examples.cps.xform.m2m.incr.puregratra.queries.behTriggerConnLost";
    }
    
    @Override
    public List<String> parameterNames() {
      return BehTriggerConnLost.Match.parameterNames;
    }
    ...
    @Override
    public BehTriggerConnLost.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof BehTriggerConnLost.Match)) {
          BehTriggerConnLost.Match other = (BehTriggerConnLost.Match) obj;
    ...
    @Override
    public BehTriggerConnLost specification() {
     ...
     * 
     */
    public static BehTriggerConnLost.Match newEmptyMatch() {
     ...
     * 
     */
    public static BehTriggerConnLost.Match newMutableMatch(final BehaviorTransition pBehTrigger, final BehaviorTransition pBehTarget) {
     ...
     * 
     */
    public static BehTriggerConnLost.Match newMatch(final BehaviorTransition pBehTrigger, final BehaviorTransition pBehTarget) {
      return new Immutable(pBehTrigger, pBehTarget);
    }
    
    private static final class Mutable extends BehTriggerConnLost.Match {
    ...
    private static final class Immutable extends BehTriggerConnLost.Match {
  ...
  /**
   * Generated pattern matcher API of the org.eclipse.viatra.examples.cps.xform.m2m.incr.puregratra.queries.behTriggerConnLost pattern,
   ...
   * 
   * @see Match
   * @see BehTriggerConnLost
   * 
   */
  public static class Matcher extends BaseMatcher<BehTriggerConnLost.Match> {
    /**
     ...
     * 
     */
    public static BehTriggerConnLost.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static BehTriggerConnLost.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(BehTriggerConnLost.Matcher.class);
     ...
     * 
     */
    public Collection<BehTriggerConnLost.Match> getAllMatches(final BehaviorTransition pBehTrigger, final BehaviorTransition pBehTarget) {
     ...
     * 
     */
    public Stream<BehTriggerConnLost.Match> streamAllMatches(final BehaviorTransition pBehTrigger, final BehaviorTransition pBehTarget) {
     ...
     * 
     */
    public Optional<BehTriggerConnLost.Match> getOneArbitraryMatch(final BehaviorTransition pBehTrigger, final BehaviorTransition pBehTarget) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final BehaviorTransition pBehTrigger, final BehaviorTransition pBehTarget, final Consumer<? super BehTriggerConnLost.Match> processor) {
     ...
     * 
     */
    public BehTriggerConnLost.Match newMatch(final BehaviorTransition pBehTrigger, final BehaviorTransition pBehTarget) {
      return BehTriggerConnLost.Match.newMatch(pBehTrigger, pBehTarget);
    }
     ...
     * 
     */
    public Stream<BehaviorTransition> streamAllValuesOfbehTrigger(final BehTriggerConnLost.Match partialMatch) {
     ...
     * 
     */
    public Set<BehaviorTransition> getAllValuesOfbehTrigger(final BehTriggerConnLost.Match partialMatch) {
     ...
     * 
     */
    public Stream<BehaviorTransition> streamAllValuesOfbehTarget(final BehTriggerConnLost.Match partialMatch) {
     ...
     * 
     */
    public Set<BehaviorTransition> getAllValuesOfbehTarget(final BehTriggerConnLost.Match partialMatch) {
    ...
    @Override
    protected BehTriggerConnLost.Match tupleToMatch(final Tuple t) {
      try {
          return BehTriggerConnLost.Match.newMatch((BehaviorTransition) t.get(POSITION_BEHTRIGGER), (BehaviorTransition) t.get(POSITION_BEHTARGET));
    ...
    @Override
    protected BehTriggerConnLost.Match arrayToMatch(final Object[] match) {
      try {
          return BehTriggerConnLost.Match.newMatch((BehaviorTransition) match[POSITION_BEHTRIGGER], (BehaviorTransition) match[POSITION_BEHTARGET]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected BehTriggerConnLost.Match arrayToMatchMutable(final Object[] match) {
      try {
          return BehTriggerConnLost.Match.newMutableMatch((BehaviorTransition) match[POSITION_BEHTRIGGER], (BehaviorTransition) match[POSITION_BEHTARGET]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<BehTriggerConnLost.Matcher> querySpecification() {
      return BehTriggerConnLost.instance();
    }
  }
  
  private BehTriggerConnLost() {
   ...
   * 
   */
  public static BehTriggerConnLost instance() {
    try{
  ...
  @Override
  protected BehTriggerConnLost.Matcher instantiate(final ViatraQueryEngine engine) {
    return BehTriggerConnLost.Matcher.on(engine);
  }
  
  @Override
  public BehTriggerConnLost.Matcher instantiate() {
    return BehTriggerConnLost.Matcher.create();
  }
  
  @Override
  public BehTriggerConnLost.Match newEmptyMatch() {
    return BehTriggerConnLost.Match.newEmptyMatch();
  }
  
  @Override
  public BehTriggerConnLost.Match newMatch(final Object... parameters) {
    return BehTriggerConnLost.Match.newMatch((org.eclipse.viatra.examples.cps.deployment.BehaviorTransition) parameters[0], (org.eclipse.viatra.examples.cps.deployment.BehaviorTransition) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: org.eclipse.viatra.examples.cps.xform.m2m.incr.puregratra.queries.BehTriggerConnLost (visibility: PUBLIC, simpleName: BehTriggerConnLost, identifier: org.eclipse.viatra.examples.cps.xform.m2m.incr.puregratra.queries.BehTriggerConnLost, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: org.eclipse.viatra.examples.cps.xform.m2m.incr.puregratra.queries) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: org.eclipse.viatra.examples.cps.xform.m2m.incr.puregratra.queries.BehTriggerConnLost (visibility: PUBLIC, simpleName: BehTriggerConnLost, identifier: org.eclipse.viatra.examples.cps.xform.m2m.incr.puregratra.queries.BehTriggerConnLost, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: org.eclipse.viatra.examples.cps.xform.m2m.incr.puregratra.queries) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final BehTriggerConnLost INSTANCE = new BehTriggerConnLost();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final BehTriggerConnLost.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          //     find connectionLost(behTrigger,behTarget)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_behTrigger, var_behTarget), ConnectionLost.instance().getInternalQueryRepresentation());
          bodies.add(body);
      }
      return bodies;
    }
