 ...
 *   <li>{@link org.eclipse.viatra.examples.cps.cyberPhysicalSystem.impl.ApplicationInstanceImpl#getPriority <em>Priority</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ApplicationInstanceImpl extends MinimalEObjectImpl.Container implements ApplicationInstance {
    ...
    public void setPriority(int newPriority) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, CyberPhysicalSystemPackage.APPLICATION_INSTANCE__PRIORITY, oldPriority, priority));
    }
