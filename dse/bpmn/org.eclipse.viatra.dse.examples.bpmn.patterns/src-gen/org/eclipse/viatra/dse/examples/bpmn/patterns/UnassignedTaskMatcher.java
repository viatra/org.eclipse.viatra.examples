...
public class UnassignedTaskMatcher extends BaseMatcher<UnassignedTaskMatch> {
   ...
   * 
   */
  public static UnassignedTaskMatcher on(final IncQueryEngine engine) throws IncQueryException {
  ...
  private final static Logger LOGGER = IncQueryLoggingUtil.getLogger(UnassignedTaskMatcher.class);
   ...
   */
  @Deprecated
  public UnassignedTaskMatcher(final Notifier emfRoot) throws IncQueryException {
   ...
   */
  @Deprecated
  public UnassignedTaskMatcher(final IncQueryEngine engine) throws IncQueryException {
  ...
  protected UnassignedTaskMatch tupleToMatch(final Tuple t) {
    try {
    	return UnassignedTaskMatch.newMatch((org.eclipse.viatra.dse.examples.simplifiedbpmn.Task) t.get(POSITION_T));
  ...
  protected UnassignedTaskMatch arrayToMatch(final Object[] match) {
    try {
    	return UnassignedTaskMatch.newMatch((org.eclipse.viatra.dse.examples.simplifiedbpmn.Task) match[POSITION_T]);
    } catch(ClassCastException e) {
  ...
  protected UnassignedTaskMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return UnassignedTaskMatch.newMutableMatch((org.eclipse.viatra.dse.examples.simplifiedbpmn.Task) match[POSITION_T]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<UnassignedTaskMatcher> querySpecification() throws IncQueryException {
