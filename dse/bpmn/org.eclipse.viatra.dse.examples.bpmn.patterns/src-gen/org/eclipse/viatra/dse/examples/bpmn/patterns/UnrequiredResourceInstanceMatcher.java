...
public class UnrequiredResourceInstanceMatcher extends BaseMatcher<UnrequiredResourceInstanceMatch> {
   ...
   * 
   */
  public static UnrequiredResourceInstanceMatcher on(final IncQueryEngine engine) throws IncQueryException {
  ...
  private final static Logger LOGGER = IncQueryLoggingUtil.getLogger(UnrequiredResourceInstanceMatcher.class);
   ...
   */
  @Deprecated
  public UnrequiredResourceInstanceMatcher(final Notifier emfRoot) throws IncQueryException {
   ...
   */
  @Deprecated
  public UnrequiredResourceInstanceMatcher(final IncQueryEngine engine) throws IncQueryException {
  ...
  protected UnrequiredResourceInstanceMatch tupleToMatch(final Tuple t) {
    try {
    	return UnrequiredResourceInstanceMatch.newMatch((org.eclipse.viatra.dse.examples.simplifiedbpmn.ResourceInstance) t.get(POSITION_RI));
  ...
  protected UnrequiredResourceInstanceMatch arrayToMatch(final Object[] match) {
    try {
    	return UnrequiredResourceInstanceMatch.newMatch((org.eclipse.viatra.dse.examples.simplifiedbpmn.ResourceInstance) match[POSITION_RI]);
    } catch(ClassCastException e) {
  ...
  protected UnrequiredResourceInstanceMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return UnrequiredResourceInstanceMatch.newMutableMatch((org.eclipse.viatra.dse.examples.simplifiedbpmn.ResourceInstance) match[POSITION_RI]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<UnrequiredResourceInstanceMatcher> querySpecification() throws IncQueryException {
