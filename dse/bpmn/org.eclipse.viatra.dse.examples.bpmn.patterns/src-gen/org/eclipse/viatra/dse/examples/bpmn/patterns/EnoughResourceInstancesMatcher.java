...
public class EnoughResourceInstancesMatcher extends BaseMatcher<EnoughResourceInstancesMatch> {
   ...
   */
  @Deprecated
  public EnoughResourceInstancesMatcher(final Notifier emfRoot) throws ViatraQueryException {
   ...
   */
  @Deprecated
  public EnoughResourceInstancesMatcher(final ViatraQueryEngine engine) throws ViatraQueryException {
