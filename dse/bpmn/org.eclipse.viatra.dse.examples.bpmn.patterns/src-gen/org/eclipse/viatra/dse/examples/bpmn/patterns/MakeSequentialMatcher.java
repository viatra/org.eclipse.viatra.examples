...
public class MakeSequentialMatcher extends BaseMatcher<MakeSequentialMatch> {
   ...
   * 
   */
  public static MakeSequentialMatcher on(final IncQueryEngine engine) throws IncQueryException {
  ...
  private final static Logger LOGGER = IncQueryLoggingUtil.getLogger(MakeSequentialMatcher.class);
   ...
   */
  @Deprecated
  public MakeSequentialMatcher(final Notifier emfRoot) throws IncQueryException {
   ...
   */
  @Deprecated
  public MakeSequentialMatcher(final IncQueryEngine engine) throws IncQueryException {
   ...
   * 
   */
  public static IQuerySpecification<MakeSequentialMatcher> querySpecification() throws IncQueryException {
