...
public class MakeSequentialMatcher extends BaseMatcher<MakeSequentialMatch> {
   ...
   */
  @Deprecated
  public MakeSequentialMatcher(final Notifier emfRoot) throws ViatraQueryException {
   ...
   */
  @Deprecated
  public MakeSequentialMatcher(final ViatraQueryEngine engine) throws ViatraQueryException {
