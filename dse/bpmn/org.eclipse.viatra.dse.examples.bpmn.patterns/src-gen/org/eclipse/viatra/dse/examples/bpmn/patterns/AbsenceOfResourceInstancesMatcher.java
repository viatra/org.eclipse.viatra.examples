...
public class AbsenceOfResourceInstancesMatcher extends BaseMatcher<AbsenceOfResourceInstancesMatch> {
   ...
   * 
   */
  public static AbsenceOfResourceInstancesMatcher on(final IncQueryEngine engine) throws IncQueryException {
  ...
  private final static Logger LOGGER = IncQueryLoggingUtil.getLogger(AbsenceOfResourceInstancesMatcher.class);
   ...
   */
  @Deprecated
  public AbsenceOfResourceInstancesMatcher(final Notifier emfRoot) throws IncQueryException {
   ...
   */
  @Deprecated
  public AbsenceOfResourceInstancesMatcher(final IncQueryEngine engine) throws IncQueryException {
  ...
  protected AbsenceOfResourceInstancesMatch tupleToMatch(final Tuple t) {
    try {
    	return AbsenceOfResourceInstancesMatch.newMatch((org.eclipse.viatra.dse.examples.simplifiedbpmn.ResourceTypeVariant) t.get(POSITION_RTV));
  ...
  protected AbsenceOfResourceInstancesMatch arrayToMatch(final Object[] match) {
    try {
    	return AbsenceOfResourceInstancesMatch.newMatch((org.eclipse.viatra.dse.examples.simplifiedbpmn.ResourceTypeVariant) match[POSITION_RTV]);
    } catch(ClassCastException e) {
  ...
  protected AbsenceOfResourceInstancesMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return AbsenceOfResourceInstancesMatch.newMutableMatch((org.eclipse.viatra.dse.examples.simplifiedbpmn.ResourceTypeVariant) match[POSITION_RTV]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<AbsenceOfResourceInstancesMatcher> querySpecification() throws IncQueryException {
