...
public class AbsenceOfResourceInstancesMatcher extends BaseMatcher<AbsenceOfResourceInstancesMatch> {
   ...
   */
  @Deprecated
  public AbsenceOfResourceInstancesMatcher(final Notifier emfRoot) throws ViatraQueryException {
   ...
   */
  @Deprecated
  public AbsenceOfResourceInstancesMatcher(final ViatraQueryEngine engine) throws ViatraQueryException {
