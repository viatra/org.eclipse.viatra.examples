...
public class VariantAllocatedToTaskMatcher extends BaseMatcher<VariantAllocatedToTaskMatch> {
   ...
   */
  @Deprecated
  public VariantAllocatedToTaskMatcher(final Notifier emfRoot) throws ViatraQueryException {
   ...
   */
  @Deprecated
  public VariantAllocatedToTaskMatcher(final ViatraQueryEngine engine) throws ViatraQueryException {
