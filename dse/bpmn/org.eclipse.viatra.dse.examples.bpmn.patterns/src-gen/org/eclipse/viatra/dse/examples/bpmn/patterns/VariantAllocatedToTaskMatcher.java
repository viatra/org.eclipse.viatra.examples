...
public class VariantAllocatedToTaskMatcher extends BaseMatcher<VariantAllocatedToTaskMatch> {
   ...
   * 
   */
  public static VariantAllocatedToTaskMatcher on(final IncQueryEngine engine) throws IncQueryException {
    // check if matcher already exists
    VariantAllocatedToTaskMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = new VariantAllocatedToTaskMatcher(engine);
  ...
  private final static Logger LOGGER = IncQueryLoggingUtil.getLogger(VariantAllocatedToTaskMatcher.class);
   ...
   */
  @Deprecated
  public VariantAllocatedToTaskMatcher(final Notifier emfRoot) throws IncQueryException {
   ...
   */
  @Deprecated
  public VariantAllocatedToTaskMatcher(final IncQueryEngine engine) throws IncQueryException {
  ...
  protected VariantAllocatedToTaskMatch tupleToMatch(final Tuple t) {
    try {
    	return VariantAllocatedToTaskMatch.newMatch((org.eclipse.viatra.dse.examples.simplifiedbpmn.Task) t.get(POSITION_T), (org.eclipse.viatra.dse.examples.simplifiedbpmn.ResourceTypeVariant) t.get(POSITION_RTV));
  ...
  protected VariantAllocatedToTaskMatch arrayToMatch(final Object[] match) {
    try {
    	return VariantAllocatedToTaskMatch.newMatch((org.eclipse.viatra.dse.examples.simplifiedbpmn.Task) match[POSITION_T], (org.eclipse.viatra.dse.examples.simplifiedbpmn.ResourceTypeVariant) match[POSITION_RTV]);
    } catch(ClassCastException e) {
  ...
  protected VariantAllocatedToTaskMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return VariantAllocatedToTaskMatch.newMutableMatch((org.eclipse.viatra.dse.examples.simplifiedbpmn.Task) match[POSITION_T], (org.eclipse.viatra.dse.examples.simplifiedbpmn.ResourceTypeVariant) match[POSITION_RTV]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<VariantAllocatedToTaskMatcher> querySpecification() throws IncQueryException {
