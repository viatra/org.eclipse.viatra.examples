...
public class AllocateTaskToVariantMatcher extends BaseMatcher<AllocateTaskToVariantMatch> {
   ...
   * 
   */
  public static AllocateTaskToVariantMatcher on(final IncQueryEngine engine) throws IncQueryException {
  ...
  private final static Logger LOGGER = IncQueryLoggingUtil.getLogger(AllocateTaskToVariantMatcher.class);
   ...
   */
  @Deprecated
  public AllocateTaskToVariantMatcher(final Notifier emfRoot) throws IncQueryException {
   ...
   */
  @Deprecated
  public AllocateTaskToVariantMatcher(final IncQueryEngine engine) throws IncQueryException {
  ...
  protected AllocateTaskToVariantMatch tupleToMatch(final Tuple t) {
    try {
    	return AllocateTaskToVariantMatch.newMatch((org.eclipse.viatra.dse.examples.simplifiedbpmn.Task) t.get(POSITION_T), (org.eclipse.viatra.dse.examples.simplifiedbpmn.ResourceTypeVariant) t.get(POSITION_RTV));
  ...
  protected AllocateTaskToVariantMatch arrayToMatch(final Object[] match) {
    try {
    	return AllocateTaskToVariantMatch.newMatch((org.eclipse.viatra.dse.examples.simplifiedbpmn.Task) match[POSITION_T], (org.eclipse.viatra.dse.examples.simplifiedbpmn.ResourceTypeVariant) match[POSITION_RTV]);
    } catch(ClassCastException e) {
  ...
  protected AllocateTaskToVariantMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return AllocateTaskToVariantMatch.newMutableMatch((org.eclipse.viatra.dse.examples.simplifiedbpmn.Task) match[POSITION_T], (org.eclipse.viatra.dse.examples.simplifiedbpmn.ResourceTypeVariant) match[POSITION_RTV]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<AllocateTaskToVariantMatcher> querySpecification() throws IncQueryException {
