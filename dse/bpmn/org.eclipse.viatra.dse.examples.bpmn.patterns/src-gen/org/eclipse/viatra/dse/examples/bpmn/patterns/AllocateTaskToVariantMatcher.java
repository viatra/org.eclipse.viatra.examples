...
public class AllocateTaskToVariantMatcher extends BaseMatcher<AllocateTaskToVariantMatch> {
   ...
   */
  @Deprecated
  public AllocateTaskToVariantMatcher(final Notifier emfRoot) throws ViatraQueryException {
   ...
   */
  @Deprecated
  public AllocateTaskToVariantMatcher(final ViatraQueryEngine engine) throws ViatraQueryException {
