...
public class MakeParallelMatcher extends BaseMatcher<MakeParallelMatch> {
   ...
   */
  @Deprecated
  public MakeParallelMatcher(final Notifier emfRoot) throws ViatraQueryException {
   ...
   */
  @Deprecated
  public MakeParallelMatcher(final ViatraQueryEngine engine) throws ViatraQueryException {
