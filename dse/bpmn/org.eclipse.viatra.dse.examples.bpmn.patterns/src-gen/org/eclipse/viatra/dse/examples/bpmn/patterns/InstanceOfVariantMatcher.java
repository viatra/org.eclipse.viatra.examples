...
public class InstanceOfVariantMatcher extends BaseMatcher<InstanceOfVariantMatch> {
   ...
   * 
   */
  public static InstanceOfVariantMatcher on(final IncQueryEngine engine) throws IncQueryException {
  ...
  private final static Logger LOGGER = IncQueryLoggingUtil.getLogger(InstanceOfVariantMatcher.class);
   ...
   */
  @Deprecated
  public InstanceOfVariantMatcher(final Notifier emfRoot) throws IncQueryException {
   ...
   */
  @Deprecated
  public InstanceOfVariantMatcher(final IncQueryEngine engine) throws IncQueryException {
  ...
  protected InstanceOfVariantMatch tupleToMatch(final Tuple t) {
    try {
    	return InstanceOfVariantMatch.newMatch((org.eclipse.viatra.dse.examples.simplifiedbpmn.ResourceInstance) t.get(POSITION_RI), (org.eclipse.viatra.dse.examples.simplifiedbpmn.ResourceTypeVariant) t.get(POSITION_RTV));
  ...
  protected InstanceOfVariantMatch arrayToMatch(final Object[] match) {
    try {
    	return InstanceOfVariantMatch.newMatch((org.eclipse.viatra.dse.examples.simplifiedbpmn.ResourceInstance) match[POSITION_RI], (org.eclipse.viatra.dse.examples.simplifiedbpmn.ResourceTypeVariant) match[POSITION_RTV]);
    } catch(ClassCastException e) {
  ...
  protected InstanceOfVariantMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return InstanceOfVariantMatch.newMutableMatch((org.eclipse.viatra.dse.examples.simplifiedbpmn.ResourceInstance) match[POSITION_RI], (org.eclipse.viatra.dse.examples.simplifiedbpmn.ResourceTypeVariant) match[POSITION_RTV]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<InstanceOfVariantMatcher> querySpecification() throws IncQueryException {
