...
public class InstanceOfVariantMatcher extends BaseMatcher<InstanceOfVariantMatch> {
   ...
   */
  @Deprecated
  public InstanceOfVariantMatcher(final Notifier emfRoot) throws ViatraQueryException {
   ...
   */
  @Deprecated
  public InstanceOfVariantMatcher(final ViatraQueryEngine engine) throws ViatraQueryException {
