 ...
 * <ul>
 *   <li>{@link org.eclipse.viatra.cep.examples.fowler.incquery.model.fowler.impl.LightImpl#getState <em>State</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LightImpl extends MinimalEObjectImpl.Container implements Light {
	 ...
	 * @ordered
	 */
	protected static final State STATE_EDEFAULT = State.OFF;
	...
	protected EClass eStaticClass() {
		return FowlerPackage.Literals.LIGHT;
	}
	...
	public void setState(State newState) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FowlerPackage.LIGHT__STATE, oldState, state));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FowlerPackage.LIGHT__STATE:
				return getState();
		}
