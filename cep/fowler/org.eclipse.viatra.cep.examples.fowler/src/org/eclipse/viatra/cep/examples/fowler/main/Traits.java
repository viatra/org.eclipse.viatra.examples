...
/**
 * Example scenario demonstrating traits as the abstraction mechanism of VEPL.
 * 
 ...
 *
 */
public class Traits extends DefaultApplication {
    ...
    public Traits() {
        super(EventContext.CHRONICLE, CepFactory.getInstance().rule_OpenSC3_3());
    }
